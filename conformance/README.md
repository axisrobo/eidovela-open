...
| O1 ops projection | P-O1-1, N-O1-1, P-O2-1 | read projections expose the agent, its evidence and outbox health; malformed pagination denied; out-of-range offset yields an empty page |
